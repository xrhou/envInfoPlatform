...
<div class=" block">
  ...
  <div style="width:1000px;height:475px;">
    <div class="biao">
      <div class="member">企业信息查询列表</div>
      <div class="member1">
       <iframe width="100%" height="445" src="${bathPath}right_index.jsp" scrolling="no" frameborder="0" name="right" id="right" style="background:none;"></iframe>
      </div>
    </div>
    &nbsp;
    <div class="news">
    	<div class="member">&nbsp;&nbsp;&nbsp;所有企业</div>
    	<iframe id="left" name="left"  width="200" height="440" src="${bathPath}left_menu.jsp" scrolling="no" frameborder="0" style="background: #e8f1f8;"></iframe>
    </div>
  </div>
  <!--友情链接-->
  <div class="clear"></div>
