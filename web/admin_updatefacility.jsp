	...
	<script type="text/javascript">
		...
		function formSubmit(){
			...
			if(facilityName.length<=0){
				parent.$.ligerDialog.warn("亲,防治污染设施名称  不能为空");
			}else{
				$.ajax({
					type: "POST",
					dataType:"text" ,
					data:"crunSid="+crunSid+"&entUserId="+entUserId+"&facilityClass="+facilityClass+"&facilityName="+facilityName+"&runTime="+runTime+"&handleAbulity="+handleAbulity+
...
<body style="padding:10px">
    ...
    <input name="crunSid" type="hidden" id="crunSid" value="${constructRunSituation.crunSid}"/>
     <table border="0" cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="facilityName" type="text" id="facilityName" value="${constructRunSituation.facilityName}" />
                </td>
                <td align="right" class="l-table-edit-td">投运时间: </td>
                <td align="left" class="l-table-edit-td">
                    <input name="runTime" type="text" id="runTime" value="${constructRunSituation.runTime}" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                </td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">处理能力:</td>
                <td align="left" class="l-table-edit-td">
                    <input name="handleAbulity" type="text" id="handleAbulity" value="${constructRunSituation.handleAbulity}"/>
                </td>
                <td align="right" class="l-table-edit-td">运维单位:</td>
                <td align="left" class="l-table-edit-td">
                    <input name="operatorUnit" type="text" id="operatorUnit" value="${constructRunSituation.operatorUnit}"/>
                </td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">运行情况:</td>
                <td align="left" class="l-table-edit-td" colspan="3"> 
                	<textarea id="runStation" rows="4" cols="60" name="runStation" >${constructRunSituation.runStation}</textarea>
                </td>
                <td align="left"></td>
            </tr>
            <tr>
