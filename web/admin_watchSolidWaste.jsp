    ...
    <input name="solidWasteId" type="hidden" id="solidWasteId" value="${solidWaste.solidWasteId}"/>
     <table border="0" cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="wasteName" type="text" id="wasteName" value="${solidWaste.wasteName}" disabled="disabled" />
                </td>
                <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
	                <select name="isDanger" id="isDanger" disabled="disabled">
							<option value="${solidWaste.isDanger}" selected="selected">${solidWaste.isDanger}</option>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="handleType" type="text" id="handleType" value="${solidWaste.handleType}"  disabled="disabled"/>
                </td>
               <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="handleNumber" type="text" id="handleNumber" value="${solidWaste.handleNumber}" disabled="disabled"/>[Kg]
                </td>
               <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<textarea id="handleDirection" rows="4" cols="18" name="handleDirection" disabled="disabled">${solidWaste.handleDirection}</textarea>
                </td>
                <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
