	...
	function formSubmit(){
		...
		if(pMouth.length<=0){
			...
			$.ajax({
				...
				url:"<%=request.getContextPath()%>/updateEntPollutionInfo", 
				isAjaxSubmit: true,
    ...
    <input name="pollutionInfoId" type="hidden" id="pollutionInfoId" value="${entPollutionInfo.pollutionInfoId}"/>
     <table border="0" cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="mgL" type="text" id="mgL" value="${entPollutionInfo.mgL}"/>[mg/L]
                </td>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="standartMGL" type="text" id="standartMGL" value="${entPollutionInfo.standartMGL}"/>[mg/L]
                </td>
