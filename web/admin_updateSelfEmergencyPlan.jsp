	...
	<script type="text/javascript">
		...
		function ajaxFileUpload() {
			...
			if(fileToUpload.length<=0){
				parent.$.ligerDialog.warn('亲,[突发应急预案附件]不能为空!');
			}else{
				$.ajaxFileUpload({
    ...
    <input name="emergencyPlanId" type="hidden" id="emergencyPlanId" value="${emergencyPlan.emergencyPlanId}"/>
     <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="planDept" type="text" id="planDept" value="${emergencyPlan.planDept}"/>
                </td>
                <td align="left"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="planTime" type="text" id="planTime" value="${emergencyPlan.planTime}" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                </td><td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">突发应急预案名称:</td>
                <td align="left" class="l-table-edit-td">
                    <input id="EmergencyPlanName" name="EmergencyPlanName" value="${emergencyPlan.emergencyPlanName}" type="text"/>
                </td><td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">突发应急预案附件:</td>
                <td align="left" class="l-table-edit-td"> 
             ...
             <tr>
                ...
                <td align="left" class="l-table-edit-td"> 
                	<textarea id="planContent"  rows="8" cols="40" name="planContent" >${emergencyPlan.planContent}</textarea>
                </td><td align="left"></td>
            </tr>
            <tr>
