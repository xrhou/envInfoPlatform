    ...
    <input name="otherInfoId" type="hidden" id="otherInfoId" value="${otherPublicInfo.otherInfoId}"/>
     <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="otherPollutionName" type="text"  value="${otherPublicInfo.otherPollutionName}" id="otherPollutionName"/>
                </td><td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">监测时间:</td>
                <td align="left" class="l-table-edit-td">
                    <input name="otherTime" type="text" id="otherTime"  class="Wdate" value="${otherPublicInfo.otherTime}" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                </td><td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">污染物详情:</td>
                <td align="left" class="l-table-edit-td"> 
                	<textarea id="otherPollutionDetail" rows="13" cols="40" name="otherPollutionDetail" >${otherPublicInfo.otherPollutionDetail}</textarea>
                </td><td align="left"></td>
            </tr>
            <tr>
