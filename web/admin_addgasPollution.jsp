...
<title>添加废气污染物排放信息</title>
	...
	<script type="text/javascript">
		...
		function formSubmit(){
			...
			if(pMouth.length<=0){
				parent.$.ligerDialog.warn('亲,[排放口位置]不能为空!');
			}else{
				$.ajax({
					type: "POST",
					dataType:"text" ,
					...
					url:"<%=request.getContextPath()%>/addGasPollutionInfoByPollutionInfoId", 
					isAjaxSubmit: true,
...
<body style="padding:10px">
    ...
    <input name="gasOrWater" type="hidden" id="gasOrWater" value="G"/>
     <table border="0" cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="mgL" type="text" id="mgL"/>[mg/m³]
                </td>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="standartMGL" type="text" id="standartMGL"/>[mg/m³]
                </td>
