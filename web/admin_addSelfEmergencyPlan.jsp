     ...
     <table cellpadding="0" cellspacing="0" class="l-table-edit" >
             <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="entName" type="text" id="entName" value="${entprise.entName}" disabled="true"/>
                </td>
                <td align="left"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="planDept" type="text" id="planDept" value=""/>
                </td>
                <td align="left"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="planTime" type="text" id="planTime" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                </td><td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">突发应急预案名称:</td>
                <td align="left" class="l-table-edit-td">
                    <input id="EmergencyPlanName" name="EmergencyPlanName" type="text"/>
                </td><td align="left"></td>
            </tr>
            <tr>
             ...
             <tr>
                ...
                <td align="left" class="l-table-edit-td"> 
                	<textarea id="planContent"  rows="13" cols="40" name="planContent" ></textarea>
                </td><td align="left"></td>
            </tr>
            <tr>
