...
<title>添加其他公开环境信息</title>
	...
	<script type="text/javascript">
		...
		function formSubmit(){
			...
			if(otherPollutionName.length<=0){
				parent.$.ligerDialog.warn('亲,[其他应当公开的污染物名称]不能为空!');
			}else{
				$.ajax({
					type: "POST",
					dataType:"text" ,
					data:"otherPollutionName="+otherPollutionName+"&otherTime="+otherTime+"&entUserId="+entUserId+"&otherPollutionDetail="+otherPollutionDetail,
					url:"<%=request.getContextPath()%>/addOtherPublicInfo", 
					isAjaxSubmit: true,
...
<body style="padding:10px">
    <input name="entUserId" type="hidden" id="entUserId" value="${entprise.entUserId}"/>
     <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                 <td align="right" class="l-table-edit-td">其他应当公开的<br/>污染物名称:</td>
                <td align="left" class="l-table-edit-td">
                    <input name="otherPollutionName" type="text" id="otherPollutionName"/>
                </td><td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">监测时间:</td>
                <td align="left" class="l-table-edit-td">
                    <input name="otherTime" type="text" id="otherTime" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                </td><td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">污染物详情:</td>
                <td align="left" class="l-table-edit-td"> 
                	<textarea id="otherPollutionDetail" rows="13" cols="40" name="otherPollutionDetail" ></textarea>
                </td><td align="left"></td>
            </tr>
            <tr>
