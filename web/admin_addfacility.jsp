    ...
    <input name="entUserId" type="hidden" id="entUserId" value="${entprise.entUserId}"/>
     <table border="0" cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="facilityName" type="text" id="facilityName"/>
                </td>
                <td align="right" class="l-table-edit-td">投运时间: </td>
                <td align="left" class="l-table-edit-td">
                    <input name="runTime" type="text" id="runTime" class="Wdate" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"/>
                </td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">处理能力:</td>
                <td align="left" class="l-table-edit-td">
                    <input name="handleAbulity" type="text" id="handleAbulity"/>
                </td>
                <td align="right" class="l-table-edit-td">运维单位:</td>
                <td align="left" class="l-table-edit-td">
                    <input name="operatorUnit" type="text" id="operatorUnit"/>
                </td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">运行情况:</td>
                <td align="left" class="l-table-edit-td" colspan="3"> 
                	<textarea id="runStation" rows="4" cols="60" name="runStation" ></textarea>
                </td>
                <td align="left"></td>
            </tr>
            <tr>
