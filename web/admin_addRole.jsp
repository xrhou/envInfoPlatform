      ...
      */ 
        ...
        function fromSubmit() {
        	...
        	$.ajax({ 
				type: "POST", 
				dataType:"text" ,
				data:"role_name="+encodeURI($("#role_name").val())+"&role_permission="+$("#role_permission").val(),
				url:"<%=request.getContextPath()%>/RoleServlet?opt=add", 
				isAjaxSubmit: true,
...
<form name="form1" id="form1">
  ...
  <tr>
    ...
    <span class="font3">角色名称:</span><input name="role_name" id="role_name" type="text"  class="bk8" /></td> 
  </tr>
</table>
</div>
    <div class="bg98"></div>
...
<div class="box">
 ...
 <table width="100%"  cellspacing="0" cellpadding="0" border="1px "  style="border-collapse:collapse;  ">
  ...
  %> --%>
  <tr>
    <td align="center"><span class="font4"><input type="checkbox" name="permission_id" id="permission_id<%-- <%=i %> --%>" value="<%-- <%=permissionVO.getPermission_id() %> --%>"/></span></td>
    <td align="center"><span class="font4"><%-- <%=permissionVO.getPermission_name() %> --%></span></td>
    ...
    <td align="center"><span class="font4"><input type="text" name="permission_order" id="permission_order<%-- <%=i %> --%>" value="" style="text-align: center;width: 30px"/></span></td>
     <td align="center">
       <span class="font4">
