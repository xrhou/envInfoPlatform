    ...
    <input name="pollutionInfoId" type="hidden" id="pollutionInfoId" value="${entPollutionInfo.pollutionInfoId}"/>
     <table border="0" cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="mgL" type="text" id="mgL" value="${entPollutionInfo.mgL}" disabled="disabled"/>[mg/m³]
                </td>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                    <input name="standartMGL" type="text" id="standartMGL" value="${entPollutionInfo.standartMGL}" disabled="disabled"/>[mg/m³]
                </td>
