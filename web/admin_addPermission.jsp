    ...
    <script type="text/javascript">
        ...
        function fromSubmit() {
        	...
        	$.ajax({ 
				type: "POST", 
				dataType:"text" ,
				data:"contentid="+contentid+"&permission_name="+encodeURI(permission_name)+
				     "&permission_url="+encodeURI(permission_url)+"&permission_flag="+encodeURI(permission_flag)+
				     "&permission_order="+encodeURI(permission_order)+
				     "&permission_grade="+encodeURI(permission_grade)+"&permission_remark="+encodeURI(permission_remark),
				url:"<%=request.getContextPath()%>/PermissionServlet?opt=add", 
				isAjaxSubmit: true,
		...
		<div></div>
		 <table cellpadding="0" cellspacing="0" class="l-table-edit" >
            <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="permission_name" id="name" type="text" id="txtName" type="text" value="" /></td>
                <td align="left"></td>
            </tr>
            <!-- 
            <tr>
                <td align="right" class="l-table-edit-td">模块URL:</td>
                <td align="left" class="l-table-edit-td"><input name="permission_url" id="url" type="text" id="txtName" type="text" value="" /></td>
                <td align="left"></td>
            </tr>
             -->
             ...
             <tr>
                ...
                <td align="left" class="l-table-edit-td"><input name="permission_grade" id="grade" type="text"  type="text" value="" /></td>
                <td align="left"></td>
            </tr>
            <tr>
                <td align="right" class="l-table-edit-td">等级说明:</td>
                <td align="left" class="l-table-edit-td"><input name="permission_remark" id="remark" type="text"  type="text" value="" /></td>
                <td align="left"></td>
            </tr>
            
            <tr>
                <td align="right" class="l-table-edit-td">显示序号:</td>
                <td align="left" class="l-table-edit-td"><input name="permission_order" id="order" type="text" id="txtName" type="text" value="" /></td>
                <td align="left"></td>
            </tr>
