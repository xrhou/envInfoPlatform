...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="${bathPath}js/easyui/demo.css">
    <script type="text/javascript" src="${bathPath}js/jquery-1.7.1.min.js"></script>
    <script type="text/javascript" src="${bathPath}js/easyui/jquery.easyui.min.js"></script>
    <script type="text/javascript" src="${bathPath}js/easyui/locale/easyui-lang-zh_CN.js"></script>
    <style type="text/css">
        #fm{
            margin:0;
            padding:10px 30px;
