...
<body style="padding:10px">
    ...
    <input name="noiseInfoId" type="hidden" id="noiseInfoId" value="${noiseInfo.noiseInfoId}"/>
     <table border="0" cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="location" type="text" id="location" value="${noiseInfo.location}"/>
                </td>
                <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
	                <input name="noiseValueDay" type="text" id="noiseValueDay" value="${noiseInfo.noiseValueDay}" />[dB]
                </td>
                <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="noiseValueNight" type="text" id="noiseValueNight" value="${noiseInfo.noiseValueNight}"/>[dB]
                </td>
               <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="dBValueDay" type="text" id="dBValueDay" value="${noiseInfo.dBValueDay}"/>[dB]
                </td>
               <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="dBValueNight" type="text" id="dBValueNight" value="${noiseInfo.dBValueNight}"/>[dB]
                </td>
               <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<textarea id="overSituation" rows="2" cols="18" name="overSituation" >${noiseInfo.overSituation}</textarea>
                </td>
                <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
