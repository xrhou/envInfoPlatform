		...
		function formSubmit(){
			...
			if(wasteName.length<=0){
				...
				$.ajax({
					type: "POST",
					dataType:"text" ,
					data:"entUserId="+entUserId+"&handleDirection="+handleDirection+"&handleNumber="+handleNumber
						+"&handleType="+handleType+"&isDanger="+isDanger+"&wasteName="+wasteName,
					url:"<%=request.getContextPath()%>/addSolidWasteBySolidWasteId", 
					isAjaxSubmit: true,
    ...
    <input name="entUserId" type="hidden" id="entUserId" value="${entprise.entUserId}"/>
     <table border="0" cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="wasteName" type="text" id="wasteName" />
                </td>
                <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="handleType" type="text" id="handleType" />
                </td>
               <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="handleNumber" type="text" id="handleNumber" />[Kg]
                </td>
               <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<textarea id="handleDirection" rows="4" cols="18" name="handleDirection" ></textarea>
                </td>
                <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
