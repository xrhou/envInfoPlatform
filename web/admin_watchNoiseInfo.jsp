	...
	<script type="text/javascript">
		...
		function formSubmit(){
			...
			$.ajax({
				type: "POST",
				dataType:"text" ,
				data:"noiseInfoId="+noiseInfoId+"&entUserId="+entUserId+"&location="+location+"&dBValueDay="+dBValueDay
					+"&dBValueNight="+dBValueNight+"&noiseValueDay="+noiseValueDay+"&noiseValueNight="+noiseValueNight+"&overSituation="+overSituation,
				url:"<%=request.getContextPath()%>/updateNoiseInfoByNoiseInfoId", 
				isAjaxSubmit: true,
...
<body style="padding:10px">
    ...
    <input name="entUserId" type="hidden" id="entUserId" value="${noiseInfo.noiseInfoId}"/>
     <table border="0" cellpadding="0" cellspacing="0" class="l-table-edit" >
            ...
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="location" type="text" id="location" value="${noiseInfo.location}" disabled="disabled"/>
                </td>
                <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
	                <input name="noiseValueDay" type="text" id="noiseValueDay" value="${noiseInfo.noiseValueDay}" disabled="disabled" />[dB]
                </td>
                <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="noiseValueNight" type="text" id="noiseValueNight" value="${noiseInfo.noiseValueNight}" disabled="disabled"/>[dB]
                </td>
               <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="dBValueDay" type="text" id="dBValueDay" value="${noiseInfo.dBValueDay}" disabled="disabled"/>[dB]
                </td>
               <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<input name="dBValueNight" type="text" id="dBValueNight" value="${noiseInfo.dBValueNight}" disabled="disabled"/>[dB]
                </td>
               <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
                ...
                <td align="left" class="l-table-edit-td">
                	<textarea id="overSituation" rows="2" cols="18" name="overSituation" disabled="disabled">${noiseInfo.overSituation}</textarea>
                </td>
                <td align="left" class="l-table-edit-td"></td>
            </tr>
            <tr>
